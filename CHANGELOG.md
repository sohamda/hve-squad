...
- Updated hve-core dependency pin to `14e4601` (14e46010407edaa194bd2bba3d4e100d8707739c).
...
```powershell
apm install "sohamda/hve-squad#v0.8.74"
```

[0.8.74]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.74
...
```powershell
apm install "sohamda/hve-squad#v0.8.73"
```

[0.8.73]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.73
...
```powershell
apm install "sohamda/hve-squad#v0.8.72"
```

[0.8.72]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.72
...
```powershell
apm install "sohamda/hve-squad#v0.8.71"
```

[0.8.71]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.71
...
```powershell
apm install "sohamda/hve-squad#v0.8.70"
```

[0.8.70]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.70
...
```powershell
apm install "sohamda/hve-squad#v0.8.69"
```

[0.8.69]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.69
...
```powershell
apm install "sohamda/hve-squad#v0.8.68"
```

[0.8.68]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.68
...
```powershell
apm install "sohamda/hve-squad#v0.8.67"
```

[0.8.67]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.67

## [0.8.66] - 2026-09-10

### Changed

- Updated hve-core dependency pin to `c8c5e94` (c8c5e94ecd22438e21460bd4b2064f8516f55603).
...
```powershell
apm install "sohamda/hve-squad#v0.8.66"
```

[0.8.66]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.66
...
```powershell
apm install "sohamda/hve-squad#v0.8.65"
```

[0.8.65]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.65
...
```powershell
apm install "sohamda/hve-squad#v0.8.64"
```

[0.8.64]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.64
...
```powershell
apm install "sohamda/hve-squad#v0.8.63"
```

[0.8.63]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.63
...
```powershell
apm install "sohamda/hve-squad#v0.8.62"
```

[0.8.62]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.62
...
```powershell
apm install "sohamda/hve-squad#v0.8.61"
```

[0.8.61]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.61
...
```powershell
apm install "sohamda/hve-squad#v0.8.60"
```

[0.8.60]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.60
...
```powershell
apm install "sohamda/hve-squad#v0.8.59"
```

[0.8.59]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.59
...
```powershell
apm install "sohamda/hve-squad#v0.8.58"
```

[0.8.58]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.58

## [0.8.57] - 2026-08-30

### Changed

- Updated hve-core dependency pin to `420ffb4` (420ffb4937c6a0ea4a00c6ccb7db1aead9668467).
...
```powershell
apm install "sohamda/hve-squad#v0.8.57"
```

[0.8.57]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.57

## [0.8.56] - 2026-08-29

### Changed

- Updated hve-core dependency pin to `8308f90` (8308f900dc2607e35447f7758d048fa11b0eb7ee).
...
```powershell
apm install "sohamda/hve-squad#v0.8.56"
```

[0.8.56]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.56

## [0.8.55] - 2026-08-27

### Changed

- Updated hve-core dependency pin to `8692fe3` (8692fe38cc0415ff8d21aa1b5d8198f008cd4038).
...
```powershell
apm install "sohamda/hve-squad#v0.8.55"
```

[0.8.55]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.55
...
```powershell
apm install "sohamda/hve-squad#v0.8.54"
```

[0.8.54]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.54
...
```powershell
apm install "sohamda/hve-squad#v0.8.53"
```

[0.8.53]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.53
...
```powershell
apm install "sohamda/hve-squad#v0.8.52"
```

[0.8.52]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.52

## [0.8.51] - 2026-08-21

### Changed

- Updated hve-core dependency pin to `6f22d31` (6f22d31bfb72be3d174521f2ddb01a8341728803).
...
```powershell
apm install "sohamda/hve-squad#v0.8.51"
```

[0.8.51]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.51
...
```powershell
apm install "sohamda/hve-squad#v0.8.50"
```

[0.8.50]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.50
...
```powershell
apm install "sohamda/hve-squad#v0.8.49"
```

[0.8.49]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.49
...
```powershell
apm install "sohamda/hve-squad#v0.8.48"
```

[0.8.48]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.48
...
```powershell
apm install "sohamda/hve-squad#v0.8.47"
```

[0.8.47]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.47
...
```powershell
apm install "sohamda/hve-squad#v0.8.46"
```

[0.8.46]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.46
...
```powershell
apm install "sohamda/hve-squad#v0.8.45"
```

[0.8.45]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.45

## [0.8.44] - 2026-08-14

### Changed

- Updated hve-core dependency pin to `2be87b7` (2be87b7ffe311daddd6f5fe4a11773efd9ae03e3).
...
```powershell
apm install "sohamda/hve-squad#v0.8.44"
```

[0.8.44]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.44
...
```powershell
apm install "sohamda/hve-squad#v0.8.43"
```

[0.8.43]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.43
...
```powershell
apm install "sohamda/hve-squad#v0.8.42"
```

[0.8.42]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.42
...
```powershell
apm install "sohamda/hve-squad#v0.8.41"
```

[0.8.41]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.41
...
```powershell
apm install "sohamda/hve-squad#v0.8.40"
```

[0.8.40]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.40
...
```powershell
apm install "sohamda/hve-squad#v0.8.39"
```

[0.8.39]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.39
...
```powershell
apm install "sohamda/hve-squad#v0.8.38"
```

[0.8.38]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.38
...
```powershell
apm install "sohamda/hve-squad#v0.8.37"
```

[0.8.37]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.37
...
```powershell
apm install "sohamda/hve-squad#v0.8.36"
```

[0.8.36]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.36
...
```powershell
apm install "sohamda/hve-squad#v0.8.35"
```

[0.8.35]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.35
...
```powershell
apm install "sohamda/hve-squad#v0.8.34"
```

[0.8.34]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.34
...
```powershell
apm install "sohamda/hve-squad#v0.8.33"
```

[0.8.33]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.33
...
```powershell
apm install "sohamda/hve-squad#v0.8.32"
```

[0.8.32]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.32
...
```powershell
apm install "sohamda/hve-squad#v0.8.31"
```

[0.8.31]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.31
...
```powershell
apm install "sohamda/hve-squad#v0.8.30"
```

[0.8.30]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.30
...
```powershell
apm install "sohamda/hve-squad#v0.8.29"
```

[0.8.29]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.29
...
```powershell
apm install "sohamda/hve-squad#v0.8.28"
```

[0.8.28]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.28
...
```powershell
apm install "sohamda/hve-squad#v0.8.27"
```

[0.8.27]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.27
...
```powershell
apm install "sohamda/hve-squad#v0.8.26"
```

[0.8.26]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.26
...
```powershell
apm install "sohamda/hve-squad#v0.8.25"
```

[0.8.25]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.25
...
```powershell
apm install "sohamda/hve-squad#v0.8.24"
```

[0.8.24]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.24
...
```powershell
apm install "sohamda/hve-squad#v0.8.23"
```

[0.8.23]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.23
...
```powershell
apm install "sohamda/hve-squad#v0.8.22"
```

[0.8.22]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.22
...
```powershell
apm install "sohamda/hve-squad#v0.8.21"
```

[0.8.21]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.21
...
```powershell
apm install "sohamda/hve-squad#v0.8.20"
```

[0.8.20]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.20
...
```powershell
apm install "sohamda/hve-squad#v0.8.19"
```

[0.8.19]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.19
...
```powershell
apm install "sohamda/hve-squad#v0.8.18"
```

[0.8.18]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.18
...
```powershell
apm install "sohamda/hve-squad#v0.8.17"
```

[0.8.17]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.17
...
```powershell
apm install "sohamda/hve-squad#v0.8.16"
```

[0.8.16]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.16
...
```powershell
apm install "sohamda/hve-squad#v0.8.15"
```

[0.8.15]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.15
...
```powershell
apm install "sohamda/hve-squad#v0.8.14"
```

[0.8.14]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.14

## [0.8.13] - 2026-07-01

### Changed

- Updated hve-core dependency pin to `19b03f7` (19b03f7b5a3b6542db4ecde29f8ff99f6ed4b3ca).
...
```powershell
apm install "sohamda/hve-squad#v0.8.13"
```

[0.8.13]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.13
...
```powershell
apm install "sohamda/hve-squad#v0.8.12"
```

[0.8.12]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.12
...
```powershell
apm install "sohamda/hve-squad#v0.8.11"
```

[0.8.11]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.11

## [0.8.10] - 2026-06-28

### Changed

- Updated hve-core dependency pin to `d06b518` (d06b518b082f888275910a42ec587b159bda8768).
...
```powershell
apm install "sohamda/hve-squad#v0.8.10"
```

[0.8.10]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.10
