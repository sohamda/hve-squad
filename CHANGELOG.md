...
```powershell
apm install "sohamda/hve-squad#v0.8.6"
```

[0.8.6]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.6

## [0.8.5] - 2026-06-23

### Changed

- Updated hve-core dependency pin to `d44ad1e` (d44ad1e0d818b93456b687758ea6e1f870854f28).
...
```powershell
apm install "sohamda/hve-squad#v0.8.5"
```

[0.8.5]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.5
...
```powershell
apm install "sohamda/hve-squad#v0.8.4"
```

[0.8.4]: https://github.com/sohamda/hve-squad/releases/tag/v0.8.4
